...
import { StrategyScene } from './scenes/strategy-march.js'
...
class App{
  ...
  go(name){const scenes={title:TitleScene,players:PlayerCountScene,setup:SetupScene,strategy:StrategyScene,siege:SiegeScene,duel:DuelScene};const Scene=scenes[name];if(!Scene)throw new Error(`Unknown scene ${name}`);this.scene=new Scene(this)}
