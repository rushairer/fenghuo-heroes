...
test('inspection executor rejects commands against enemy cities',()=>{const s=new GameStore(new MemoryStorage());s.newGame({humanFactions:['cao']});assert.equal(s.executeInspection('train','xinye'),'只能向本國城池下令。')})
